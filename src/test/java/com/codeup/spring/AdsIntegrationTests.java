...
public class AdsIntegrationTests {
    ...
    @Autowired
    private PasswordEncoder passwordEncoder;//<---from bean created in security
    ...
    public void setup() throws Exception {
        ...
        httpSession = this.mvc.perform(post("/login").with(csrf())//more actions ...import mockmvc for post
